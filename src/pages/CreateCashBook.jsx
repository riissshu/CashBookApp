...
function CreateCashBook() {
  ...
  const handleSave = async () => {
    try {
      ...
      await saveCashBook(cashbookId, date, narration.trim(), transactions);
  ...
  return (
    <div className="container-fluid py-4">
      <div className="d-flex justify-content-between align-items-center mb-4">
        <h2 className="mb-0">Create Cash Book</h2>
                ...
                <table className="table table-bordered align-middle mb-0">
                      ...
                      <tr key={item.id}>
                        ...
                        <td>
                          <input
                            ...
                            value={item.amount}
                            onChange={(e) =>
                              updateReceipt(item.id, "amount", e.target.value)
                            }
                          />
                        </td>
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <th className="text-end">₹{totalReceipt.toFixed(2)}</th>
                ...
                <table className="table table-bordered align-middle mb-0">
                      ...
                      <tr key={item.id}>
                        ...
                        <td>
                          <input
                            ...
                            value={item.amount}
                            onChange={(e) =>
                              updatePayment(item.id, "amount", e.target.value)
                            }
                          />
                        </td>
                  ...
                  <tfoot>
                    <tr>
                      ...
                      <th className="text-end">₹{totalPayment.toFixed(2)}</th>
      ...
      <div className="card mt-4">
        <div className="card-body">
          <div className="d-flex justify-content-between align-items-center">
            ...
            <div>
              <h4 className="mb-0">₹{closingBalance.toFixed(2)}</h4>
            </div>
          </div>
        </div>
      </div>
